...
public class UserFavoriteTopicActivity extends BaseActivity {
  ...
  public static Intent getCallingIntent(Context context, String username) {
    Intent callingIntent = new Intent(context, UserFavoriteTopicActivity.class);
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    ab.setTitle(R.string.my_favorite);

    UserTopicFragment fragment = (UserTopicFragment) getSupportFragmentManager()
        .findFragmentById(R.id.container);

    if (fragment == null) {
      fragment = UserTopicFragment.newInstance(username, TYPE_FAVORITE);
